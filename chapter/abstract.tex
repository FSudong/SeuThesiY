...
\title{基于知识图谱的IT运维辅助系统的设计与分析}{基于知识图谱的 \rotatebox{270}{IT} 运维辅助系统的设计与分析}{智能运维}{智能运维}{Design and Analysis of IT Operation and Maintenance Assistant System based on Knowledge Graph}{AIOps}
...
\begin{abstract}{智能运维，知识图谱，表示学习，故障预测}
    ...
    \begin{itemize}
        \item [1)] 
        基于机器学习自动化构建组件-事件知识图谱。本文将事件特征拓展至6种，并训练了机器学习分类模型判别事件间有无因果关系，进而利用历史数据沉淀出了组件-事件知识图谱，缓解了知识图谱构建的人工消耗。   
        \item [2)]
