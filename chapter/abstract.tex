%===============================================================================
%非盲审
% \categorynumber{TP311.52} % 分类采用《中国图书资料分类法》
...
% \committeechair{\quad}
% \reviewer{\quad}{\quad}
% \department{东南大学软件学院}{The College of Software Engineering}
% 盲审
\categorynumber{TP311.5} % 分类采用《中国图书资料分类法》
\UDC{004.41}            %《国际十进分类法UDC》的类号
\secretlevel{公开}    %学位论文密级分为"公开"、"内部"、"秘密"和"机密"四种
\studentid{184607}   %学号要完整，前面的零不能省略。\quad 
\title{基于知识图谱的IT运维辅助系统设计与实现}{基于知识图谱的 \rotatebox{270}{IT} 运维辅助系统设计与实现}{\quad}{\quad}{Design and Implementation of IT Operation and Maintenance Assistant System Based on Knowledge Graph}{}
\author{方苏东}{FANG Sudong}
\advisor{漆桂林}{教授}{QI Guilin}{Prof.}
\coadvisor{丁岩}{高工}{DING Yan}{Ir.} % 没有% 可以不填
\degreetype{工程硕士}{Master of Engineering} % 详细学位名称
...
\defenddate{\today}
\authorizedate{\quad}
\committeechair{何洁月教授}
\reviewer{盲审}{}
\department{东南大学软件学院}{College of Software Engineering}
...
% https://blog.csdn.net/HEHEEH123/article/details/109776288
