...
% \documentclass[figurelist,tablelist, nomlist, engineering, openany,ctexbook]{config/seuthesiY}
\documentclass[figurelist,tablelist,nomlist,engineering]{config/seuthesiY}
